...
<main>
    ...
    <form method="POST" onsubmit="excluirProduto();" id="excluirForm">

        <label for="nome">Nome</label>
        <input type="text" id="nome" name="nome" placeholder="<?php echo $row['nome']; ?>" value="<?php echo $row['nome']; ?>" readonly>
        ...
        <input type="text" id="descricao" name="descricao" placeholder="<?php echo $row['descricao']; ?>" value="<?php echo $row['descricao']; ?>" readonly>

        <label for="preco">Preço</label>
        <input type="text" id="preco" name="preco" placeholder="<?php echo $row['preco']; ?>" value="<?php echo $row['preco']; ?>" readonly>
        ...
        <input type="submit" name="excluir" class="botao-cadastrar" value="Excluir produto" />
    </form>
...
<script>
    ...
    Swal.fire({
        ...
        const url = `processar-excluir-produto.php?nome=${nome}&tipo=${tipo}&descricao=${descricao}&preco=${preco}&id=${id}&imagem=${fileName}`;
